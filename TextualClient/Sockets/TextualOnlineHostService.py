...
from TextualClient.Sockets.SocketServer import SocketServer, OnMessageReceivedCallBack
...
class TextualOnlineHostService(ITextualOnlineService):
    ...
    def on_msg_player_join_socket_server(
        ...
        this: TextualOnlineHostService = cast(Self, kwargs['this'])
        ...
        self.chess_socket_server = SocketServer(
            on_message_received=[
                OnMessageReceivedCallBack(
                    on_message_received=TextualOnlineHostService.on_msg_player_join_socket_server,
                    kwarg_values={
                        'this': self,
